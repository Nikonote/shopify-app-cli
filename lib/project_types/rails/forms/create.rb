      ...
      def ask_db
        if db.nil?
          ...
          @db = CLI::UI::Prompt.ask(ctx.message('rails.forms.create.db.select')) do |handler|
            handler.option(ctx.message('rails.forms.create.db.select_sqlite')) { 'sqlite3' }
            handler.option(ctx.message('rails.forms.create.db.select_mysql')) { 'mysql' }
            handler.option(ctx.message('rails.forms.create.db.select_pg')) { 'postgresql' }
            handler.option(ctx.message('rails.forms.create.db.select_oracle')) { 'oracle' }
            handler.option(ctx.message('rails.forms.create.db.select_fb')) { 'frontbase' }
            handler.option(ctx.message('rails.forms.create.db.select_ibm')) { 'ibm_db' }
            handler.option(ctx.message('rails.forms.create.db.select_sql')) { 'sqlserver' }
            handler.option(ctx.message('rails.forms.create.db.select_jdbc_mysql')) { 'jdbcmysql' }
            handler.option(ctx.message('rails.forms.create.db.select_jdbc_sqlite')) { 'jdbcsqlite3' }
            handler.option(ctx.message('rails.forms.create.db.select_jdbc_pg')) { 'jdbcpostgresql' }
            handler.option(ctx.message('rails.forms.create.db.select_jdbc')) { 'jdbc' }
          end
        end
